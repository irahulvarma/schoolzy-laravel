                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('update-user-profile') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="position" type="text" class="form-control @error('position') is-invalid @enderror" name="position" value="{{ Auth::user()->position }}" required autocomplete="position" autofocus>
